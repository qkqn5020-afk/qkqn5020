          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                answer: '베카24는 실내 야구연습장, 카페, 다양한 오락기기, 로봇탁구를 함께 즐길 수 있는 24시 무인 복합 스포츠 시설입니다. 홈런짱24는 야외에서 야구연습을 할 수 있는 24시 무인 야구연습장 브랜드입니다. 두 브랜드 모두 무인 운영 시스템을 기반으로 스포츠와 놀이, 휴식이 결합된 창업 모델입니다.'
              },
              {
              ...
              {
                question: '전국 어디서든 창업 상담이 가능한가요?',
                answer: '네, 가능합니다. 베카24, 홈런짱24, 24시 무인 짱탁구장은 부산과 양산뿐 아니라 대한민국 전국 어디서든 창업 상담이 가능합니다. 희망 지역의 상권, 매장 규모, 운영 방식에 맞춰 무인 야구연습장, 무인 탁구장, 무인 스포츠 창업 방향을 함께 검토할 수 있습니다.'
              }
            ].map((item, index) => (
              <div
                key={index}
